...
class UpdateTypeOfExpense @Inject constructor(private val typeOfExpenseRepository: TypeOfExpenseRepository) {
    suspend operator fun invoke(typeOfExpense: TypeOfExpense) =
        typeOfExpenseRepository.updateTypeOfExpense(typeOfExpense)
}